...
public class TicketMasterAPI implements ExternalAPI {
	...
	private static final String API_KEY = "EwjzPLW2GaFhrZovGPHPsqmULpO8s9Iw";
	
	@Override
	public List<Item> search(double lat, double lon, String term) {		// create a base url, based on API_HOST and SEARCH_PATH
		...
		String query = String.format("apikey=%s&geoPoint=%s&classificationName=%s&radius=50", API_KEY, geoHash, term);
		try {
	...
	public static void main(String[] args) {
		...
		// Los Angeles, CA
		tmApi.queryAPI(34.0522, -118.2437);
		// London, UK
